...
class Custome8221_SQLReportsViewDetail extends ViewDetail
{
    ...
    public function display()
    {
        ...
        */
        ...
        $jsonData = html_entity_decode($JSONDataSQLReport); //  // strval  (string)
        $jsonHead = html_entity_decode($JSONHeadSQLReport);
        ...
        */
        ...
        <script>
            ...
            let JSONDataSQLReport = '<?php echo html_entity_decode($JSONDataSQLReport);?>';
            const data = JSONDataSQLReport;
            const jsonObj = $.parseJSON(JSONDataSQLReport); // = JSON.stringify
            console.log(jsonObj);
            /*for (i in jsonObj)
             {
